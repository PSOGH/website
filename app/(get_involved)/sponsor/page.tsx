...
export default async function SponsorPage({}: Props) {
  ...
  return <>
    ...
    <div className="my-6 w-full overflow-y-auto">
      ...
      <div className="md:w-3/4 md:min-h-[1120px] mx-auto invisible md:visible">
        ...
        <iframe src="https://ik.imagekit.io/gps/psogh/va_24/PSGH-%20_VA23%20GENEROUS%20SPONSORSHIP%20PACKAGE-compressed.pdf" style={{width:'100%', height:'100%'}}></iframe>
      </div>
