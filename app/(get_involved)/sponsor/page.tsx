  ...
  return <>
    ...
    <div className="my-6 w-full overflow-y-auto">
      <table className="w-full table-fixed min-w-[1150px]">
        <thead>
          <TitleRowComponent item_title="Sponsorship Incentives" sponsor_packages={['Grand Sponsor', 'Platinum Sponsor', 'Diamond Sponsor', 'Gold Sponsor', 'Silver Sponsor', 'Bronze Sponsor', 'Rose Sponsor']} />
        </thead>
        <tbody>
          <RowComponent value="" checks={['$ 5,000', '$ 2,500', '$ 2,000', '$ 1,500', '$ 1,000', '$ 500', '$ 250']} />
          <RowComponent value="Introducing YOU as a Brand at all media platforms" checks={['yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no']} />
          <RowComponent value="Award & Sponsor Recognition by Chief Official Host" checks={['yes', 'yes', 'yes', 'no', 'no', 'no', 'no']} />
          <RowComponent value="Award & Sponsor Recognition" checks={['yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no']} />
          <RowComponent value="Tickets included" checks={['yes:20 VIP', 'yes:10 VIP', 'yes:8 VIP', 'yes:6 VIP', 'yes:4 VIP', 'yes:2 VIP', 'yes:1 Premium']} />
          <RowComponent value="VIP Box seating option available" checks={['yes', 'yes', 'no', 'no', 'no', 'no', 'no']} />
          <RowComponent value="Highlight spot to display business promotional material" checks={['yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no']} />
          <RowComponent value="Logo & Brand presence on website and all social media platform" checks={['yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no']} />
          ...
          <RowComponent value="Opportunity to present your brand during the program" checks={['yes:5 min', 'yes:3 min', 'no', 'no', 'no', 'no', 'no']} />
          <RowComponent value="Recognition as host committee sponsor" checks={['yes', 'yes', 'no', 'no', 'no', 'no', 'no']} />
          ...
          <RowComponent value="Color advertisement in the event souvenir" checks={['yes:Full page', 'yes:Full page', 'yes:1/2 page', 'yes:1/2 page', 'yes:1/4 page', 'no', 'no']} />
        </tbody>
      </table>
      ...
      <SponsorshipFormComponent event_code={'va25'} sponsor_types={sponsor_types} sponsorshipLevels={sponsorshipLevels} />
    </div>
  </>
}
