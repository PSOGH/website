...
async function SponsorshipFormComponent({ event_code, sponsor_types, sponsorshipLevels }: Props) {
  return <Card className='w-full md:w-5/6 mt-6 mx-auto'>
    <CardHeader>
      ...
      <CardDescription className=''>Please use this form to confirm your sponsorship pledge. Once the pledge has been made and payment processed, you will recieve the confirmation of benefits. You can make payments using:</CardDescription>
      ...
      <p className="ml-4 leading-7 [&:not(:first-child)]:mt-6 text-muted-foreground text-sm">
        <span className='font-semibold'>Check</span> payable to: Punjabi Society of Greater Houston
      </p>
    </CardHeader>
    <CardContent>
