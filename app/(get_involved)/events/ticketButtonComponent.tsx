    ...
    {/* <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <Button asChild variant={'ghost'}><a href="https://www.etix.com/ticket/p/55618256/grand-vaisakhi-2025-gajda-wajda-punjab-stafford-official-box-office-for-stafford-centre">Click here to open ticketting page separately</a></Button>
        </DialogHeader>
        <iframe src="https://www.etix.com/ticket/p/55618256/grand-vaisakhi-2025-gajda-wajda-punjab-stafford-official-box-office-for-stafford-centre" width="100%" height="100%" allow="autoplay" style={{minHeight: '500px'}}></iframe>
      </DialogContent>
    </Dialog> */}
  </>
}
