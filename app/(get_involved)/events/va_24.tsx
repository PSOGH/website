  ...
  return <Card>
    <CardHeader>
      ...
      <div className='grid grid-cols-10 gap-2 mt-2'>
        ...
        <Button asChild className='col-span-8 col-start-2 md:col-span-2 bg-teal-600 text-gray-50 hover:bg-teal-200 hover:text-gray-700' variant={'outline'}><Link href='/events/va_24'><TicketIcon className='mr-2' /> Tickets</Link></Button>
