...
export default function Vaisakhi24({}: Props) {
  return <Card className='mt-2'>
      <CardHeader className='text-xl font-bold'>
        <CardTitle>Upcoming Event: Grand Vaisakhi Mela 2024 | Ticket Sale Coming soon!!</CardTitle>
        ...
        <div className='grid grid-cols-10 gap-2 mt-2'>
          ...
          <Button asChild className='col-span-8 col-start-2 md:col-span-2 bg-teal-600 text-gray-50 hover:bg-teal-200 hover:text-gray-700' variant={'outline'} disabled><Link href='/events/va_24'><TicketIcon className='mr-2' /> Tickets</Link></Button>
